angular
    .module('systems.signinteraction', [
        'ces',
        'three',
        ...
        function($log, System, Signal, EntityBuilder, IbUtils, Timer, $components, THREE, GlobalSound, INV_SLOTS, ItemService, INV_TYPES) {
            ...
            var SignInteractionSystem = System.extend({
                ...
                addedToWorld: function(world) {
                    ...
                    world.entityAdded('signinteraction').add(function(entity) {
                        var inventoryComponent = entity.getComponent('signinteraction');
                        world.publish('signinteraction:load', entity);
                    });
                ...
                update: function() {
                    ...
                    if (Meteor.isClient) {
                        if (interactionSystem._interactionTimer.isExpired) {
                            ...
                            var grabbers = this.world.getEntities('signinteraction', 'player'),
                            signs = this.world.getEntities('sign');
