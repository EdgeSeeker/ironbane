angular
    ...
    .constant('IB_CONSTANTS', {
        ...
        world: {
            mainMenuLevel: Meteor.settings.public.useDevZone ? 'dev-zone-2' : 'ravenwood',
            startLevel: Meteor.settings.public.useDevZone ? 'dev-zone-2' : 'ravenwood'
        },
        characterParts: {
            male: {
        ...
        isDev: Meteor.isClient ? (window.location.hostname !== 'play.nerdquest.com') : !process.env.IS_PROD
    })
    .run([
        'IB_CONSTANTS',
